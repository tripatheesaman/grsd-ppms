...
export const WORKFLOW_QUEUES: WorkflowQueueConfig[] = [
  ...
  },
  {
    ...
    description: "Awaiting financial committee review and recommendation",
    href: "/procurements/financial-committee",
    icon: Scale,
    statuses: ["WITH_FINANCE"],
    showBidderCount: true,
    bidderCountMode: "passed-tech",
  ...
  {
    key: "loi-pending-loa",
    label: "LOI pending / LOA pending",
    shortLabel: "LOI pending",
    description: "Winner selected or LOI issued; procurement is awaiting the next LOI/LOA step",
    href: "/procurements/loi-pending-loa",
    icon: Mail,
    statuses: ["WINNER_SELECTED", "LOI_ISSUED"],
    showBidderCount: false,
